...
pub fn interpret_tree(tree: Vec<tree_creator::TreeNode>, key_list: &HashMap<String, Box<dyn yttrium_key_base::Key>>, mut environment: Environment) -> Result<InterpretationResult, String> {
