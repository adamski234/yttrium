...
pub fn interpret_string(ars_string: String, key_list: &HashMap<String, Box<dyn yttrium_key_base::Key>>, environment: yttrium_key_base::environment::Environment) -> Result<ResultAndWarnings, errors_and_warns::Error> {
